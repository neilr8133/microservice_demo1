...
be made publically-available on a repository site.

This file contains the assignment instructions; README.md contains the
normal project-specific stuff that one would expect to find in a README.
